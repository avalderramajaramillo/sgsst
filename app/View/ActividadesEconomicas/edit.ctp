...
<?php echo $this->Form->create('ActividadesEconomica'); ?>
	<fieldset>
		<legend><?php echo __('Edit Actividades Economica'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActividadesEconomica.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ActividadesEconomica.id')))); ?></li>
