...
<?php echo $this->Form->create('Correo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Correo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Correo.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Correo.id')))); ?></li>
