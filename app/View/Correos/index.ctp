<div class="correos index">
	...
	<tr>
		<td><?php echo h($correo['Correo']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($correo['Correo']['correo_electronico']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $correo['Correo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $correo['Correo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $correo['Correo']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $correo['Correo']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
