...
<?php echo $this->Form->create('CargosPersona'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cargos Persona'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CargosPersona.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('CargosPersona.id')))); ?></li>
