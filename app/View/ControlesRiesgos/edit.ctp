...
<?php echo $this->Form->create('ControlesRiesgo'); ?>
	<fieldset>
		<legend><?php echo __('Edit Controles Riesgo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ControlesRiesgo.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ControlesRiesgo.id')))); ?></li>
