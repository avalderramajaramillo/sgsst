...
<?php echo $this->Form->create('ActividadesEconomicasSede'); ?>
	<fieldset>
		<legend><?php echo __('Edit Actividades Economicas Sede'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActividadesEconomicasSede.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ActividadesEconomicasSede.id')))); ?></li>
