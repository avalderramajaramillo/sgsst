...
<?php echo $this->Form->create('EmpresasPersona'); ?>
	<fieldset>
		<legend><?php echo __('Edit Empresas Persona'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EmpresasPersona.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('EmpresasPersona.id')))); ?></li>
